...
title.Text = "Offline HUB Key System"
...
SubmitButton.MouseButton1Click:Connect(function()
    ...
    if KeySystem == "VK7JG-NPHTM-C97JM-9MPGT-3V66T" then   
screenGui:Destroy()
...
GetKeyButton.MouseButton1Click:Connect(function()
 setclipboard("https://gitlab.com/offlineplayer-01/key-system.lua/-/raw/main/README.md") 
end) 
